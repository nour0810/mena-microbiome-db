...
This project is released under the [CC BY 4.0 License](LICENSE).  
...
For questions, data updates, or collaboration inquiries, please open an [issue](https://github.com/nour0810/mena-microbiome-db/issues) on GitHub.
